  ...
  return {
    ...
    check: function (measures) {
        ...
        measures.entries.forEach(entry => {
          ...
          if (cookiesLength !== 0) {
            ...
            if (domains.has(domain)) {
              if (domains.get(domain) < cookiesLength) {
            ...
            if (cookiesLength > this.specificMeasures.maxCookiesLength) {
              this.specificMeasures.maxCookiesLength = cookiesLength;
            }
          }
        });
      }
      ...
      if (this.specificMeasures.maxCookiesLength !== 0) {
        ...
        if (this.specificMeasures.maxCookiesLength > 512) {
          this.complianceLevel = 'B';
        }
        if (this.specificMeasures.maxCookiesLength > 1024) {
